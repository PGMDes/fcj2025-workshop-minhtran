...
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2   | Học về Domain 1: Cloud Concept và Tìm ra được các lợi ích của AWS Cloud<br>- Học lại về 5 tiêu chí của điện toán đám mây<br>- Hạ tầng<br>- Phân biệt được Khả năng sẵn có so với Khả năng chịu đựng so với Khả năng phục hồi<br>- Phân biệt Scaling và Elastic<br>- Xác định các nguyên tắc thiết kế của AWS Cloud<br>- AWS Well-Architected Framework<br>- General Design Principles<br>- 6 trụ cột chính                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 20/10/2025   | 20/10/2025    |  |
| 3   | Học về Domain 1: Cloud Concept và Tìm ra được các lợi ích của AWS Cloud<br>- Hiểu được lợi ích và chiến lược di chuyển lên Đám mây AWS<br>- AWS Cloud Adoption Framework<br>- Cloud Adoption Stages<br>- 7 Migration Strategies (The 7 R's)<br>- Migration Services & Scenarios<br>- Hiểu về Thanh toán, Giá cả và Hỗ trợ (Cloud Econmics, TCO, Reduce Cost, ..)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 21/10/2025   | 21/10/2025    |  |
| 4   | Học về Domain 2: Bảo mật và tuân thủ<br><br>- 2.1 Hiểu mô hình trách nhiệm chung của AWS ( AWS is responsible for, Customer is responsible in, Trách nhiệm THAY ĐỔI Dựa trên Dịch vụ)<br>- 2.2 Hiểu các khái niệm về bảo mật, quản trị và tuân thủ của AWS Cloud (AWS Security, Gorvernance and Compliance)<br>- 2.3 Xác định khả năng quản lý truy cập AWS(roor, IAM, Cognito, IAM Policies, )<br>- 2.4 Xác định các thành phần và tài nguyên cho bảo mật ( Security Group, NACL, WAF)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | 22/10/2025   | 22/10/2025    |                                             |
| 5   | Học về Domain 3: Công nghệ và dịch vụ đám mây<br><br>- 3.1 Định nghĩa các phương pháp của deloying và operation trong AWS Cloud<br> + Phương pháp của Deploy và Operating<br> + Các loại Cloud hiện nay?<br> + So sánh dịch vụ Public và Private<br> + Các lựa chọn kết nối<br>- 3.2 Xác định cơ sở hạ tầng toàn cầu của AWS<br> + Tìm hiểu về hạ tầng của AWS<br> + Tiện ích mở rộng khu vực<br> + Dịch vụ Edge: CloudFront so với Global Accelerator<br> + Các khái niệm chính về AZ và DR<br>- 3.3 Xác định tài nguyên tính toán AWS<br> + Amazon EC2<br> + Lưu trữ trên EC2<br> + Các loại EC2 Instance<br> + Cấu hình EC2<br> + Containers<br> + Tính toán không máy chủ<br> + So sánh High Availability vs. Scalability<br> - 3.4 Xác định tài nguyên tính toán AWS<br> + Tìm hiểu về Amazon RDS<br> + Tìm hiểu về Amazon Aurora<br> + Tìm hiểu về Amazon DynamoDB<br> + Cơ sở dữ liệu trong bộ nhớ (Amazon ElastiCache, Amazon DynamoDB Accelerator - DAX)<br> + Tìm hiểu về Amazon RedShift<br> + Tìm hiểu về Migration Database ( AWS Snow Family, AWS DMS, AWS DataSync)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 23/10/2025   | 23/10/2025    |                                    |
| 6   | Học về Domain 3: Công nghệ và dịch vụ đám mây<br><br>- 3.5 Xác định tài nguyên mạng AWS<br> + Tìm hiểu về Amazon VPC<br> + Các loại VPC<br> + Các thành phần cốt lõi của VPC<br> + Bảo mật VPC<br> + VPC Gateways<br> + VPC & Hybrid Connectivity<br> + DNS & Routing<br>- 3.6 Xác định tài nguyên lưu trữ AWS<br> + Các loại lưu trữ đám mây<br> + Tìm hiểu lưu trữ đối tượng: Amazon S3<br> + Tìm hiểu về lưu trữ tệp : EFS vs. FSx<br> + Lưu trữ khối: EBS so với Lưu trữ phiên bản<br> + Các loại khối lượng EBS<br> + Lưu trữ kết hợp: AWS Storage Gateway<br> + Tìm hiểu về Backup<br>- 3.7 Xác định các dịch vụ trí tuệ nhân tạo và máy học của AWS cũng như các dịch vụ phân tích<br> + Tìm hiểu cơ bản về AI/ML<br> + 3 cấp độ của AWS ML ( AI Service, ML Services, ML Frameworks & Infrastructure)<br> + Các dịch vụ phân tích dữ liệu ( Amazon Athena, Amazon Macie, Amazon Redshift, Amazon Kinesis, Amazon Glue, Amazon QuickSight, Amazon EMR)<br>- 3.8 Xác định các dịch vụ từ các danh mục dịch vụ AWS khác trong phạm vi<br> + Giám sát & Khả năng quan sát (CloudWatch, X-ray, EventBridge)<br> + Tìm hiểu về các dịch vụ tích hợp ứng dụng ( Amazon SQS, Amazon SNS)<br> + Sự khác nhau của Dịch vụ kinh doanh và khách hàng (Amazon Connect, Amazon SES, AWS Activate, AWS IQ,...)<br> + Các công cụ cho người phát triển và DevOps (AWS Code Commit, AWS CodeBuild, AWS CodeDeploy,.....)<br> + Tính toán End-User (Amazon AppStream 2.0, Amazon WorkSpaces, Amazon WorkSpacesWeb)<br> + Tim hiểu về dịch vụ cho Frontend Wed và Mobile ( AWS Amplify, AWS AppSync)<br> + Dịch vụ hỗ trợ IOT (AWS IoT Core, AWS IoT Greengrass) | 24/10/2025   | 24/10/2025    |      |
